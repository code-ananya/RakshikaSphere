          ...
          <div className="row align-items-center">
            <div className="col-sm-12 col-lg-5 text-center text-lg-start">
              ...
              <h2 className="about_title">
                Welcome to RakshikaSphere Empowering Women, Ensuring Safety
              </h2>
              <p className="about_text " style={{ textAlign: "justify" }}>
                At RakshikaSphere, we are dedicated to creating a safer world for
          ...
          <div className="container">
            <div className="row align-items-center">
              ...
              <div className="col-sm-12 col-lg-6 text-center text-lg-start">
                ...
                <h2 className="about_title">Why Rakshika Sphere?</h2>
                <p className="about_text" style={{ textAlign: "justify" }}>
