            ...
            <section className='banner_wrapper'>
                <div className='container'>
                    <div className='row align-items-center'>
                        <div className='col-md-6 header-img-section' style={{ position: 'relative', textAlign: 'center' }}>
                            <img
                                src={logo}
                                alt='RakshikaSphere'
                                style={{
                        ...
                        <div className="col-md-6 my-5 my-md-0 text-center text-md-start">
                            ...
                            <div className="learn-more-btn-section">
                                <Link to='/emergency' style={{ backgroundColor: 'red' }} className="nav-link learn-more-btn btn-header">Emergency</Link>
                            </div>
                        </div>
                    </div>
                </div>
